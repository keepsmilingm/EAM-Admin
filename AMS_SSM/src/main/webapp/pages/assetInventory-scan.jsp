...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <div id="view">
            <img id="codePic" style="max-width: 300px" alt="">
        </div>
            ...
            <div class="panel panel-default">
                ...
                <div class="row data-type">
                    <form id="assetForm">
                        ...
                        <div class="col-md-2 title">报废类型</div>


                        <div class="col-md-12 title">报废原因</div>
    ...
    function goSubmit() {
        ...
        for(var i=0;i<assetIds.length;i++){
            ...
            $.ajax({
                ...
                url: "${pageContext.request.contextPath}/assetScrap/addScrap.do",
                dataType: "JSON",
                // contentType: "application/json",
        ...
        if(flag){
            izToast("success","新增报废");
        }else{
            izToast("success","新增报废");
        }
        setTimeout(function () {
            window.location.href="${pageContext.request.contextPath}/assetScrap/findAllSend.do?page=1&size=10&senderId="+JSON.parse($.getCookie("userInfo")).id+"&checkStatus=0";
