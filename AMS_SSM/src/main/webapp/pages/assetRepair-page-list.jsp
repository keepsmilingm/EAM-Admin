            ...
            <div class="row">
                <div class="col-md-3">
                    <a data-btn-type="titleBtn" data-flag="new" class="btn btn-primary btn-block margin-bottom"
                       href="${pageContext.request.contextPath}/asset/fuzzyQuery.do?page=1&size=10&condition=">新增维修</a>

                    <div class="box box-solid">
                        <div class="box-header with-border">
                            <h3 class="box-title">我的维修</h3>
...
<script>
    ...
    function senderChangeOption(option){
        ...
        location.href = "${pageContext.request.contextPath}/assetRepair/findAllSend.do?page=1&size=10"
            + "&senderId="+JSON.parse($.getCookie("userInfo")).id+"&checkStatus="+option;

    }
    function receiverChangeOption(option){
        location.href = "${pageContext.request.contextPath}/assetRepair/findAllReceive.do?page=1&size=10"
    ...
    if(getUrlParam("checkerId")!==false){
         firstPage="${pageContext.request.contextPath}/assetRepair/findAllReceive.do?page=1&size=${pageInfo.pageSize}&checkerId="+getUrlParam("checkerId")+"&checkStatus="+getUrlParam("checkStatus");
         previousPage="${pageContext.request.contextPath}/assetRepair/findAllReceive.do?page=${pageInfo.pageNum-1}&size=${pageInfo.pageSize}&checkerId="+getUrlParam("checkerId")+"&checkStatus="+getUrlParam("checkStatus");
         nextPage="${pageContext.request.contextPath}/assetRepair/findAllReceive.do?page=${pageInfo.pageNum+1}&size=${pageInfo.pageSize}&checkerId="+getUrlParam("checkerId")+"&checkStatus="+getUrlParam("checkStatus");
         lastPage="${pageContext.request.contextPath}/assetRepair/findAllReceive.do?page=${pageInfo.pages}&size=${pageInfo.pageSize}&checkerId="+getUrlParam("checkerId")+"&checkStatus="+getUrlParam("checkStatus");
        ...
        $('#lastPage').attr("href",lastPage);
         ...
         firstPage="${pageContext.request.contextPath}/assetRepair/findAllSend.do?page=1&size=${pageInfo.pageSize}&senderId="+getUrlParam("senderId")+"&checkStatus="+getUrlParam("checkStatus");
         previousPage="${pageContext.request.contextPath}/assetRepair/findAllSend.do?page=${pageInfo.pageNum-1}&size=${pageInfo.pageSize}&senderId="+getUrlParam("senderId")+"&checkStatus="+getUrlParam("checkStatus");
         nextPage="${pageContext.request.contextPath}/assetRepair/findAllSend.do?page=${pageInfo.pageNum+1}&size=${pageInfo.pageSize}&senderId="+getUrlParam("senderId")+"&checkStatus="+getUrlParam("checkStatus");
         lastPage="${pageContext.request.contextPath}/assetRepair/findAllSend.do?page=${pageInfo.pages}&size=${pageInfo.pageSize}&senderId="+getUrlParam("senderId")+"&checkStatus="+getUrlParam("checkStatus");
        $('#firstPage').attr("href",firstPage);
        $('#previousPage').attr("href",previousPage);
        $('#nextPage').attr("href",nextPage);
        $('#lastPage').attr("href",lastPage);
