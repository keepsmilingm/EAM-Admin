                ...
                <div class="col-md-3">
                    <security:authorize access="hasRole('ADMIN')">
                        <a data-btn-type="titleBtn" data-flag="new" class="btn btn-primary btn-block margin-bottom"
                           href="${pageContext.request.contextPath}/department/findDepList.do">新建部门消息
                        </a>
                    </security:authorize>

                    <a data-btn-type="titleBtn" data-flag="new" class="btn btn-primary btn-block margin-bottom"
                       href="${pageContext.request.contextPath}/user/fuzzyQuery.do?page=1&size=10&condition=">新建个人消息
                    </a>

                    <div class="box box-solid">
                        <div class="box-header with-border">
                            <h3 class="box-title">我的收件箱</h3>
                        ...
                        <div class="box-body no-padding" id="folder">
                            <ul class="nav nav-pills nav-stacked" id="checkStatusPanel">
                                <li class="" >
                                    <a onclick="changeStatus(0)">
                                        <i class="fa fa-inbox"></i>
                                        <p style="display: inline-block">未读消息</p>
                                        <span class="label label-primary pull-right">0</span>
                                    </a>
                                </li>
                                <li ><a onclick="changeStatus(1)"><i class="fa fa-envelope-o"></i>
                                    <p style="display: inline-block">已读消息</p>
                                    <span class="label label-info pull-right">0</span></a></li>
                                <li ><a onclick="changeStatus(2)"><i
                                        class="fa fa-file-text-o"></i>
                                    <p style="display: inline-block">收藏夹</p>
                                    <span class="label label-warning pull-right">0</span></a></li>
                                <li ><a onclick="changeStatus(3)"><i class="fa fa-trash-o"></i>
                                    <p style="display: inline-block">回收站</p>
                    ...
                    <div class="box box-solid">
                        ...
                        <div class="box-body no-padding">
                            <ul class="nav nav-pills nav-stacked" id="typePanel">
                                <li><a onclick="changeType(0)"><i class="fa fa-tv text-danger"></i>一般消息
                                    <span class="label label-info pull-right">0</span></a></li></a></li>
                                <li><a onclick="changeType(1)"><i class="fa fa-envelope-o text-info"></i>紧急通知
                                    <span class="label label-danger pull-right">0</span></a></li></a></li>
                                <li><a onclick="changeType(2)"><i class="fa fa-mobile text-success fa-lg"></i>通知消息
                                ...
                                <div class="table-box">
                                    ...
                                    <div class="pull-left">
                                        <div class="form-group form-inline">
                                            <div class="btn-group">
                                                ...
                                                <a href="${pageContext.request.contextPath}/user/fuzzyQuery.do?page=1&size=10&condition=&orderbys="
                                    ...
                                    <table id="dataList"
                                        ...
                                        <tr>
                                            ...
                                            <th class="">ID</th>
                                            <th id="account" class="orderBy ">标题</th>
                                            <th id="username" class="orderBy  ">消息类型</th>
                                            <th id="status" class="orderBy  ">时间</th>
                                            <th id="checkStatus" class="orderBy  ">状态</th>
                                        ...
                                        <c:forEach items="${pageInfo.list}" var="orders">
                                            ...
                                            <tr>
                                                <td><input name="ids" type="checkbox" value="${orders.messageId }"></td>
                                                <td>${orders.messageId}</td>
                                                <td>${orders.message.des }</td>
                                                <td>${orders.message.typeStr}</td>
                                                <td>${orders.message.sendTimeStr }</td>
                                                <td>${orders.checkStatusStr }</td>
                                                <td>${orders.message.sender}</td>
                                                <td class="text-center">
                                                        <%--												<button type="button" class="btn bg-olive btn-xs">订单</button>--%>
                                                    <button type="button" class="btn bg-olive btn-xs"
                                                            onclick="location.href='${pageContext.request.contextPath}/message/findM_CById.do?messageId=${orders.messageId}&receiverId=<%=session.getAttribute("userId")%>'">
                                                        详情
                                                    </button>
                                                    <button type="button" class="btn bg-olive btn-xs"
                                                            onclick="location.href='${pageContext.request.contextPath}/message/delete.do?id=${orders.messageId}'">
                                                        删除
                                                    </button>
                                                </td>
                                            </tr>
                            ...
                            <div class="box-footer">
                                ...
                                <div class="box-tools pull-right">
                                    <ul class="pagination" style="height: inherit">
                                        <li>
                                            <a href="${pageContext.request.contextPath}/message/findByType.do?page=1&size=${pageInfo.pageSize}&userId=<%=session.getAttribute("userId")%>&checkStatus=<%=session.getAttribute("checkStatus")%>"
                                               aria-label="Previous">首页</a>
                                        </li>
                                        <li>
                                            <a href="${pageContext.request.contextPath}/message/findByType.do?page=${pageInfo.pageNum-1}&size=${pageInfo.pageSize}&userId=<%=session.getAttribute("userId")%>&checkStatus=<%=session.getAttribute("checkStatus")%>">上一页</a>
                                        </li>
                                        ...
                                        <%--						   </c:forEach>--%>
                                        <li>
                                            <a href="${pageContext.request.contextPath}/message/findByType.do?page=${pageInfo.pageNum+1}&size=${pageInfo.pageSize}&userId=<%=session.getAttribute("userId")%>&checkStatus=<%=session.getAttribute("checkStatus")%>">下一页</a>
                                        </li>
                                        <li>
                                            <a href="${pageContext.request.contextPath}/message/findByType.do?page=${pageInfo.pages}&size=${pageInfo.pageSize}&userId=<%=session.getAttribute("userId")%>&checkStatus=<%=session.getAttribute("checkStatus")%>"
...
<script>
    ...
    if(getUrlParam("checkStatus")!==false){
        $('#checkStatusPanel').find('li').each(function() {
    ...
    if(getUrlParam("type")!==false){
        $('#typePanel').find('li').each(function() {
            if ($(this).index() == getUrlParam("type")) {
                $(this).addClass("active");
            }
        })
    }
    ...
    function changePageSize() {
        ...
        location.href = "${pageContext.request.contextPath}/message/findByType.do?page=1&size="
            + pageSize + "&userId=" + JSON.parse($.getCookie("userInfo")).id +"&checkStatus="+currentCheckStatus;
    ...
    function changeStatus(checkStatus){
        ...
        var pageSize = $page.val();
        location.href = "${pageContext.request.contextPath}/message/findByType.do?page=1&size="
            + pageSize + "&userId=" + JSON.parse($.getCookie("userInfo")).id +"&checkStatus="+checkStatus;
    ...
    function changeType(type){
        ...
        var pageSize = $page.val();
        location.href = "${pageContext.request.contextPath}/message/findByType.do?page=1&size="
            + pageSize + "&userId=" + JSON.parse($.getCookie("userInfo")).id +"&type="+type;
    ...
    $("#deleteItems").click(function () {
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/message/deleteItems.do",
            type: "post",
            traditional: true,
            // dataType:"text",
            data: {
            ...
            success: function (datas) {
                console.log((datas));
                location.href = "${pageContext.request.contextPath}/message/findByType.do?page=1&size=10&userId="+JSON.parse($.getCookie("userInfo")).id+"&checkStatus="+checkStatus; ;
            }
        });
