            ...
            <div class="panel panel-default">
                ...
                <div class="row data-type">
                    <form id="assetForm">
                        ...
                        <div class="col-md-2 title">盘点类型</div>


                        <div class="col-md-12 title">盘点原因</div>
    ...
    function goSubmit() {
        ...
        for(var i=0;i<assetIds.length;i++){
            ...
            $.ajax({
                ...
                url: "${pageContext.request.contextPath}/assetInventory/addInventory.do",
                dataType: "JSON",
                // contentType: "application/json",
