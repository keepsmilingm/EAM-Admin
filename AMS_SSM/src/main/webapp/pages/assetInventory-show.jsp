            ...
            <div class="panel panel-default">
                ...
                <div class="row data-type">
                    ...
                    <div class="box-tools text-center">
                        ...
                        <button type="button" class="btn bg-success" onclick=checkOption(${orders.id},${orders.assetId},"normal",0)>正常</button>
                        <button type="button" class="btn bg-success" onclick=checkOption(${orders.id},${orders.assetId},"Repair",1)>维修</button>
                        <button type="button" class="btn bg-success" onclick=checkOption(${orders.id},${orders.assetId},"Scrap",2)>报废</button>
...
<script>
    ...
    //是否同意通过
    function checkOption(id,assetId,option,status) {
        console.log(status);
        checkbox_arr=[];
        checkbox_arr.push(assetId);
        localStorage.setItem("assetIds",checkbox_arr.toString());

            $.ajax({
                url: "${pageContext.request.contextPath}/assetInventory/changeCheckStatus.do",
                dataType: "JSON",
                data:JSON.stringify(
                    {
                        id:id,
                ...
                success: function (datas) {
                    ...
                    setTimeout(function () {
                        window.location.href="${pageContext.request.contextPath}/assetInventory/findAllSend.do?page=1&size=10&senderId="+JSON.parse($.getCookie("userInfo")).id+"&checkStatus=0";
