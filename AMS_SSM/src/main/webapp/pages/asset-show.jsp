...
<head>
    ...
    <style>
        #qrcode img{ max-height: 200px;text-align: center}
        #qrcode canvas{ max-height: 200px;text-align: center}
    </style>
</head>
				...
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input id="code" type="text" class="form-control" placeholder="资产编号"
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control"
								   value="${asset.cunfangdi }" name="cunfangdi">
						</div>
						<div class="col-md-2 title">单价</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control"
								   value="${asset.status }" name="status">
						</div>
						...
						<div class="col-md-12 title" >二维码</div>
                        <div class="col-md-12" style="text-align: center;width: 200px">
                            <!--startprint-->
                            <div id="qrcode" class="docs-pictures"></div>
                            <!--endprint-->
                        </div>
...
<%--					<button  onclick="my_print()" class="btn bg-maroon">打印二维码</button>--%>
					<a href="${pageContext.request.contextPath}/pages/asset-print.jsp?code=${asset.bianma}" class="btn bg-maroon">打印二维码</a>
