            ...
            <div class="row">
                <div class="col-md-3">
                    <a data-btn-type="titleBtn" data-flag="new" class="btn btn-primary btn-block margin-bottom"
                       href="${pageContext.request.contextPath}/asset/findAll.do">新增报废</a>

                    <div class="box box-solid">
                        <div class="box-header with-border">
                            <h3 class="box-title">我的报废</h3>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <button type="button" class="btn bg-olive btn-xs"
                                                            onclick="location.href='${pageContext.request.contextPath}/assetScrap/findById.do?id=${orders.id}'">
                                                        详情
                                                    </button>
                                                    <button type="button" class="btn bg-olive btn-xs"
                                                            onclick="location.href='${pageContext.request.contextPath}/assetScrap/delete.do?id=${orders.id}'">
                                                        删除
                                                    </button>
                                                </td>
                                            </tr>
...
<script>
    ...
    function senderChangeOption(option){
        ...
        location.href = "${pageContext.request.contextPath}/assetScrap/findAllSend.do?page=1&size=10"
            + "&senderId="+JSON.parse($.getCookie("userInfo")).id+"&checkStatus="+option;

    }
    function receiverChangeOption(option){
        location.href = "${pageContext.request.contextPath}/assetScrap/findAllReceive.do?page=1&size=10"
    ...
    $("#deleteItems").click(function () {
        ...
        $.ajax({
            ...
            success: function (datas) {
                console.log((datas));
                location.href = "${pageContext.request.contextPath}/assetOption/findOptionList.do?page=1&size=10&option=Scrap&senderId="+JSON.parse($.getCookie("userInfo")).id;
            }
        });
    ...
    <%--<li>--%>
    <%--<a id="firstPage" href="${pageContext.request.contextPath}/assetOption/findOptionList.do?page=1&size=${pageInfo.pageSize}&senderId=<%=session.getAttribute("senderId")%>&checkerId=<%=session.getAttribute("checkerId")%>&option=<%=session.getAttribute("option")%>"--%>
    <%--aria-label="Previous">首页</a>--%>
    <%--    </li>--%>
    <%--    <li>--%>
    <%--    <a id="previousPage" href="${pageContext.request.contextPath}/assetOption/findOptionList.do?page=${pageInfo.pageNum-1}&size=${pageInfo.pageSize}&senderId=<%=session.getAttribute("senderId")%>&checkerId=<%=session.getAttribute("checkerId")%>&option=<%=session.getAttribute("option")%>">上一页</a>--%>
    <%--    </li>--%>

    <%--    <li>--%>
    <%--    <a id="nextPage" href="${pageContext.request.contextPath}/assetOption/findOptionList.do?page=${pageInfo.pageNum+1}&size=${pageInfo.pageSize}&senderId=<%=session.getAttribute("senderId")%>&checkerId=<%=session.getAttribute("checkerId")%>&option=<%=session.getAttribute("option")%>">下一页</a>--%>
    <%--    </li>--%>
    <%--    <li>--%>
    <%--    <a id="lastPage" href="${pageContext.request.contextPath}/assetOption/findOptionList.do?page=${pageInfo.pages}&size=${pageInfo.pageSize}&senderId=<%=session.getAttribute("senderId")%>&checkerId=<%=session.getAttribute("checkerId")%>&option=<%=session.getAttribute("option")%>"--%>
    ...
    if(getUrlParam("checkerId")!==false){
        firstPage="${pageContext.request.contextPath}/assetScrap/findAllReceive.do?page=1&size=${pageInfo.pageSize}&checkerId="+getUrlParam("checkerId")+"&checkStatus="+getUrlParam("checkStatus");
        previousPage="${pageContext.request.contextPath}/assetScrap/findAllReceive.do?page=${pageInfo.pageNum-1}&size=${pageInfo.pageSize}&checkerId="+getUrlParam("checkerId")+"&checkStatus="+getUrlParam("checkStatus");
        nextPage="${pageContext.request.contextPath}/assetScrap/findAllReceive.do?page=${pageInfo.pageNum+1}&size=${pageInfo.pageSize}&checkerId="+getUrlParam("checkerId")+"&checkStatus="+getUrlParam("checkStatus");
        lastPage="${pageContext.request.contextPath}/assetScrap/findAllReceive.do?page=${pageInfo.pages}&size=${pageInfo.pageSize}&checkerId="+getUrlParam("checkerId")+"&checkStatus="+getUrlParam("checkStatus");
        ...
        firstPage="${pageContext.request.contextPath}/assetScrap/findAllSend.do?page=1&size=${pageInfo.pageSize}&senderId="+getUrlParam("senderId")+"&checkStatus="+getUrlParam("checkStatus");
        previousPage="${pageContext.request.contextPath}/assetScrap/findAllSend.do?page=${pageInfo.pageNum-1}&size=${pageInfo.pageSize}&senderId="+getUrlParam("senderId")+"&checkStatus="+getUrlParam("checkStatus");
        nextPage="${pageContext.request.contextPath}/assetScrap/findAllSend.do?page=${pageInfo.pageNum+1}&size=${pageInfo.pageSize}&senderId="+getUrlParam("senderId")+"&checkStatus="+getUrlParam("checkStatus");
        lastPage="${pageContext.request.contextPath}/assetScrap/findAllSend.do?page=${pageInfo.pages}&size=${pageInfo.pageSize}&senderId="+getUrlParam("senderId")+"&checkStatus="+getUrlParam("checkStatus");
        $('#firstPage').attr("href",firstPage);
        $('#previousPage').attr("href",previousPage);
        $('#nextPage').attr("href",nextPage);
        $('#lastPage').attr("href",lastPage);
