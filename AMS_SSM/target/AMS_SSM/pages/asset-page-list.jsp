							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										...
										<button type="button" class="btn btn-default" title="新增报废" onclick=AssetOption("Repair")>
											<i class="fa fa-trash-o"></i> 新增报废
										</button>
										<button type="button" class="btn btn-default" title="新增变更" onclick=AssetOption("Repair")>
											<i class="fa fa-trash-o"></i>新增变更
										</button>
										<button type="button" class="btn btn-default" title="新增盘点" onclick=AssetOption("Repair")>
							...
							<table id="dataList"
								...
								<thead>
									<tr>
										...
										<th id="price" class="orderBy sorting_asc ">价格</th>
										<th id="creatTime" class="orderBy sorting_asc ">购入时间</th>
										<th class=" sorting_asc sorting_asc_disabled">规格型号</th>
								...
								<tbody>
									...
									<c:forEach items="${pageInfo.list}" var="orders">
										...
										<tr>
											...
											<td>${orders.price }</td>
											<td>${orders.creatTimeFormat}</td>
											<td>${orders.guigexinghao }</td>
