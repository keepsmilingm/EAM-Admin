...
<%--                                            <th id="gender" class="orderBy  ">状态</th>--%>
                                        ...
                                        <c:forEach items="${pageInfo.list}" var="orders">
                                            ...
                                            <tr>
                                                ...
                                                <td>${orders.id }</td>
                                                <td>${orders.des }</td>
                                                <td>${orders.typeStr}</td>
                                                <td>${orders.sendTime }</td>
<%--                                                <td>${orders.checkStatus }</td>--%>
                                                <td>${orders.sender}</td>
                                                <td class="text-center">
                                                        <%--												<button type="button" class="btn bg-olive btn-xs">订单</button>--%>
                                                    <button type="button" class="btn bg-olive btn-xs"
                                                            onclick="location.href='${pageContext.request.contextPath}/message/findM_CById.do?messageId=${orders.id}&receiverId=<%=session.getAttribute("userId")%>'">
                                                        详情
                                                    </button>
                                                    <button type="button" class="btn bg-olive btn-xs"
                                                            onclick="location.href='${pageContext.request.contextPath}/message/delete.do?id=${orders.id}'">
                                                        删除
                                                    </button>
                                                </td>
                                            </tr>
